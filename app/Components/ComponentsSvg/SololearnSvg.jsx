...
export default function SololearnSvg() {
  return (
    <Svg viewBox="0 0 2225.2 2230.7" xmlns="http://www.w3.org/2000/svg" width={'100%'} height={80}>
      <G strokeMiterlimit={10}>
        <Path
          d="M699.9 98.8S102.6 798.2 835.6 1577.3c0 0-643.4-214-713.4-713.4 0 0-103.5-509.1 577.7-765.1z"
          fill="#6bb94f"
          stroke="#6bb94e"
        />
        <Path
