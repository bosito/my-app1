...
export default function MenuPrincipal(props) {
    ...
    return (
        <View style={Styles.container}>
            ...
            <MyBoton title={'ejercicio1'} onPress={() => navigation.navigate('example1')} navigation={navigation} />
            ...
            <MyBoton title={'Carrusel animable'} onPress={() => navigation.navigate('example6')} navigation={navigation} />
        </View>
    )
}
